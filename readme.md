...
<div align="center">
<img src="img/server.png" alt="服务示例" width="50%">
</div>
...
在 `labs/08_benchmark_eval.R` 脚本的实测中，测试 `causal_lm`、`latent_residual`、`world_model` 三个模型在 100 道机器学习领域试题上的最终准确率。
